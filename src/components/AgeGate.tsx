        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <button
                className="inline-flex cursor-pointer touch-manipulation items-center justify-center rounded-full border border-white px-12 py-4 text-sm font-semibold uppercase tracking-widest text-white transition-all duration-300 hover:bg-white hover:text-black active:bg-white active:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                onClick={onAllow}
              >
                Yes
              </button>
